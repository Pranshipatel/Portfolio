      ...
      {showContent && (
        <div className="main w-full rotate-[-10deg] scale-[1.7]">
          <div className="landing  overflow-hidden relative w-full h-screen bg-black">
            ...
            <div className="imagesdiv relative overflow-hidden w-full h-screen">
              ...
              <div className="text text-white flex flex-col gap-3 absolute top-20 left-1/2 -translate-x-1/2 scale-[1.4] rotate-[-10deg]">
                <h1 className="text-[12rem] leading-none -ml-40">Hey, This is</h1>
                <h1 className="text-[12rem] leading-none ml-20">Pranshi</h1>
                <h1 className="text-[12rem] leading-none -ml-40">patel</h1>
              </div>
              <img
                className=" absolute character -bottom-[150%] left-[70%] -translate-x-1/2  scale-[3] rotate-[-20deg] w-3xl h-[90%]"
                src="./cg-1.png"
                alt=""
              />
            </div>
          ...
          <div className="sec-page w-full h-screen flex items-center justify-between  bg-black">
            <div className="cntnr flex  text-white  h-[90%]">
              <div className="limg relative w-[50%] h-full">
                <img
                  className="absolute scale-[1.3] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[60%]"
                  src="./cg-2.png"
                  alt=""
                />
              </div>
